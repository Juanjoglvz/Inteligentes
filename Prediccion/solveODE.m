...
[x1, y1] = ode45(odes, tspanBefore, [0, population - 2, 2, 0, 0]);

dquarantinedt = y1(end, 2) * quarantinePercent;

[x2, y2] = ode45(odes, tspanAfter, [dquarantinedt, y1(end, 2) - dquarantinedt, y1(end, 3), y1(end, 4), y1(end, 5)]);
...
dydt = [ -1 * dquarantinedt
        -1 * beta * S * I / population - 0;
        beta * S * I / population - gamma * I - theta * I + dquarantinedt;
        gamma * I;
        theta * I];
end
